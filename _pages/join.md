...
* **Post-bach, pre-doc, external, and visiting students**: Want to spend 4 -- 6 months doing research in the Princeton RL Group? Apply by emailing me with a paragraph about what you'd like to work on. Ideally, this should reference some of the prior/ongoing work in the lab. For example, identity some limitation of our prior work and propose a solution. Or, find a bug in a proof. Also, in this email, mention your citizenship/visa status, as this can affect hiring.
